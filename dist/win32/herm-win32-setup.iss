...
[Run]
Filename: "{cmd}"; Parameters: "/C """"{app}\python\pythonw.exe"" -m compileall ""{app}"""""
Filename: "{cmd}"; Parameters: "/C """"{app}\src\tools\log_install_hermes.bat"" ""{commonappdata}\HERMES"""""; Flags: runhidden 
