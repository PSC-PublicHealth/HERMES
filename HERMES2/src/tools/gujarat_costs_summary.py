...
baseDir = './'
directories = [{'Title':'IPV 10 Dose','dir':'Gujarat-10dose','outPre':'output'},
...
#	       {'Title':'Rotavac + IPV Introduction','dir':baseDir+'Rota-IPV','outPre':'output'},
#	       {'Title':'Rotavac + IPV + PCV Introduction','dir':baseDir+'UIP-Rota-PCV-IPV','outPre':'output'},
#	       {'Title':'UIP As Needed Transport','dir':baseDir+'UIP-AsNeeded','outPre':'output'},
#	       {'Title':'All Introductions As Needed Transport','dir':baseDir+'All-AsNeeded','outPre':'output'},
	       ]
#directories = [{'Title':'District Loops','dir':'All-DistrictLoops','outPre':'output'},
#	       {'Title':'PHC Loops','dir':'All-PHCLoops','outPre':'output'},
#	       {'Title':'District Removal','dir':'Dist-Removed','outPre':'output'},
#	       {'Title':'District Removal Loops','dir':'Dist-Removed-Loops','outPre':'output'}
#	     ]
def main():
    ...
    for expt in directories:
        ...
        resultDict = {'Avail':{},'OverAllVA':0.0,'Wastage':{},'FIC':0.0,'Doses':0.0,'StorageCost':{},
                      'Maintanence':{'Central':0.0,'Division':0.0,'District':180000,'District_s':0.0,'PHC':522000,'OutreachClinic':0.0},
                      'CB':{'Central':0.0,'Division':0,'District':279749,'District_s':0.0,'PHC':2017827,'OutreachClinic':0.0},
    ...
    for level in LevelOrder:
        ...
        col+=1
        for expt in results:
	    if level in expt[1]['Maintanence'].keys():
    ...
    for level in LevelOrder:
        ...
        col+=1
        for expt in results:
            if level in expt[1]['TransportCost'].keys():
