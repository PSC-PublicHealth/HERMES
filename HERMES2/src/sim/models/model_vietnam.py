...
class Model(model.Model):
    ...
    def __init__(self, sim):
        ...
        self.factoryProductFilterDict= {1:self.sim.vaccines.getCollection([(sim.vaccines.getTypeByName('V_HepB'),1.0),
                                        ...
                                        2:self.sim.vaccines.getCollection([(sim.vaccines.getTypeByName('V_Tuberculosis'),1.0),
                                                                           ...
                                                                           (sim.vaccines.getTypeByName('V_Rotavirus_V5'),1.0),
                                                                           (sim.vaccines.getTypeByName('V_Pneumococcal13'),1.0),
    ...
    def _scaleDemandByType(self, shipDosesVC):
        ...
        for v,nVials in shipVialsTupleList:
            if self.updateWasteEstimateFreq > 0:
                ...
                elif v.name=='V_Tetanus_Toxoid': wastage= 1.0-0.1
                else:
...
#            return Model.districtStoreStartupLatency
    ...
    def warehouseOrClinicFromRec(self, sim, rec, expectedType,
        ...
        elif function=='Administration' and (coolStorage==0 or issubclass(expectedType,warehouse.AttachedClinic)):
