...
class UserInput:
    ...
    def __init__(self,userInputFileName=None, useDb=None, resultsGroupId=None, dbSession=None):
...
#                     UserInput.defaultTokenDict[rec['Keyword']] = KeywordTokenDefinition(rec)
        ...
        if useDb:
            ...
            strRecs = shd_db.getDbInputRecs(userInputFileName, resultsGroup=resultsGroupId,session_in=dbSession)
