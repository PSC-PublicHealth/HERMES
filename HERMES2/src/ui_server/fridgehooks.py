...
fieldMap = [{ 'label':_('HERMES DB Id'), 'key':'Name', 'id':'name', 'info':False,'edit':False,'type':'dbkey'},
            ...
            { 'label':_('Make'), 'key':'Make', 'id':'make','info': True,'edit':True,'type':'string'},  
            { 'label':_('Model'), 'key':'Model', 'id':'model','info': True, 'edit':True, 'type':'string'},  
            { 'label':_('Year'), 'key':'Year', 'id':'year','info': True, 'edit':True, 'type':'string'},  
            { 'label':_('Net Volume for 2-8C Storage (L)'), 'key':'cooler', 'id':'cooler','info': True, 'edit':True,'type':'float'},
            { 'label':_('Net Volume for Below 0C Storage'), 'key':'freezer', 'id':'freezer','info': True, 'edit':True,'type':'float'},
            { 'label':_('Net Volume for Room Temperature Storage (L)'), 'key':'roomtemperature', 'id':'roomtemperature', 
            'info': True, 'edit':True, 'type':'float'},
            { 'label':_('Category of Device'), 'key':'Category', 'id':'category', 'info': True, 'edit':True,'type':'string'},  
            { 'label':_('Type of Technology'), 'key':'Technology', 'id':'technology','info': False, 'edit':False, 'type':'string'},  
            { 'label':_('Requires'), 'key':'Requires', 'id':'requires','info': False, 'edit':False, 'type':'string'},  
            { 'label':_('Capital Cost of Device'),'key':'BaseCost','id':'basecost','info': True, 'edit':True,'type':'cost','recMap':['BaseCost','BaseCostCurCode','BaseCostYear']},
            { 'label':_("Years To Amortize"), 'key':'AmortYears', 'id':'amortyears', 'info': True, 'edit':True, 'type':'float'},
            { 'label':_('Type of Energy Used'), 'key':'Energy', 'id':'energy', 'info': True,'edit':True, 'type':'select',
             'options':energyOptions},
            { 'label':_('Rate of Energy Usage'), 'key':'PowerRate', 'id':'powerrate','info': True, 'type':'dynamicunit',
                'lookup':'Energy','lookupDict':energyTranslationDict,'recMap':['PowerRate','PowerRateUnits']},  
            { 'label':_('Hold Days with No Power'), 'key':'NoPowerHoldoverDays', 'id':'nopowerholdoverdays', 'info': True, 'edit':False,'type':'float'},  
            { 'label':_('Behavior'), 'key':'ClassName', 'id':'classname','info': True, 'edit':True, 'type':'select',
            ...
            { 'label':_('Hold Time of the Device'), 'key':'ColdLifetime', 'id':'coldlifetime','info': True, 'edit':False, 'type':'float',
             'default':5.0},
            { 'label':_('AlarmDays'), 'key':'AlarmDays', 'id':'alarmdays', 'info': False,'edit':False,'type':'float'},
            { 'label':_('SnoozeDays'), 'key':'SnoozeDays', 'id':'snoozedays', 'info': False, 'edit':False, 'type':'float'},
