...
<div id="remlevexpt_slides">
	<div id="remlevexpt_slide1" class='remlevexpt_slide'>
		<span class='expt_subtitle'>
			{{_('Description of Removing a Supply Chain Level Experiments')}}
		</span>
		<p class='expt_text'>
			{{_('Supply chains typically have a series of intermediate levels through which to ship products until they finally arrive at the locations where they will be given to patients.')}}
			{{_('The levels bring product closer to other locations and generally provide stability and security of stock as they move through the supply chain.')}}
			{{_('However, sometimes a supply chain level is not necessary and actually makes the supply chain cost more, and a more efficient supply chain may be obtained by bypassing or removing a supply chain level and rerouting shipping routes directly.')}}
	...
	<div id="remlevexpt_slide2" class='remlevexpt_slide'>
		<div class="flex_cols">
			...
			<div id='remlevexpt_route_opts' class="expt_txt" style="display:none">
				<p class='expt_text'>
					{{_('Now you must select how the new routes between locations at the supply chain levels will be defined.  Please select one of the following options')}}
				</p>
				<p>
				...
				<p>
					<label for="remlevexpt_custom" class='remlevexpt_opts_label'>
						{{_('Define your own route characteristics')}}
					</label>
