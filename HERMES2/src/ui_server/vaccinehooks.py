...
#                             'default':'Liquid'
#                          },
             { 'label':_('Length of time vaccine can be used after opening vial'), 'key':'openLifetime', 'id':'lifetimeopen', 'info': True, 'edit':True, 'type':'time', 'req':True, 'recMap':['openLifetime', 'openLifetimeUnits'],'default':[28,'days']},
