...
fieldMap = [{'row':1, 'label':_('Name'), 'key':'Name', 'id':'name', 'type':'string'},
            ...
            {'row':4, 'label':_('Vaccine price/dose'), 'key':'pricePerDose', 'id':'priceperdose', 'type':'hide'},  
            {'row':4, 'label':_('Vaccine price/vial'), 'key':'pricePerVial', 'id':'pricepervial', 'type':'float'},  
            {'row':4, 'label':_('Price Units'), 'key':'priceUnits', 'id':'priceunits', 'type':'string'},           
            {'row':5, 'label':_('Requires'), 'key':'Requires', 'id':'requires', 'type':'string'},  
            {'row':5, 'label':_('Notes'), 'key':'Notes', 'id':'notes', 'type':'string'},
            {'row':5, 'label':_('RandomKey'), 'key':'RandomKey', 'id':'randomkey', 'type':'int'},
            {'row':5, 'label':_('SortOrder'), 'key':'SortOrder', 'id':'sortorder', 'type':'int'},              
