...
def addAVaccineExptSummary(db,uiSession):
    try:
        ...
        htmlArray.append( "<a href='{0}model-add-types?id={1}&startClass=vaccines'>".format(rootPath,modelId))
        ...
        htmlArray.append( "<td class='hermes_expt_summary_table_placeholder_col'></td>")
        htmlArray.append( "<td class='hermes_expt_summary_table_col' colspan=3>")
        htmlArray.append( "<a href='{0}model-add-types?id={1}&startClass=people'>".format(rootPath,modelId))
