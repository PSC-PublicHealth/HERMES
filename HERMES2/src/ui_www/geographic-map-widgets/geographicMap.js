...
*/
;(function($){
	$.widget("geographic-map.geographicMap",{
		options:{
			rootPath:'',
			modelId:'',
		...
		_create:function(){
			...
			translate_phrases(phrases)
				...
				.defer(d3.json,rootPath+"json/model-geo-structure?modelId="+modelId)
				...
				function ready(error, stateJSON, countryJSON, ppJSON, roadsJSON, geoJSON){
					console.log(geoJSON);
					storeJSON = geoJSON.storejson;
					routesJSON = geoJSON.routejson;
